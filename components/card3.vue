    ...
    <v-row align="center" justify="center" dense>
      <v-col cols="12" md="3">
        ...
        <p v-if="ksm.Nama_ksm === item.Ksm.Nama_ksm">
          ...
          <v-card variant="tonal" class="mx-auto" color="surface-variant" :title="ksm.Nama_ksm" :subtitle="ksm.id"
...
const jadwal = await $fetch(
  `https://satu.dev.rssa.id/items/data_jadwal_jaga_dokter?fields=id,Nama_petugas,Ksm.Nama_ksm,Level.Nama_level_igd,Jaga_awal,Jaga_akhir&filter[day(Jaga_awal)][_eq]=15&filter[month(Jaga_awal)][_eq]=05&filter[year(Jaga_awal)][_eq]=2024`
);
