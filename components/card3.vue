...
const jadwal = await $fetch(`https://satu.dev.rssa.id/items/data_jadwal_jaga_dokter?filter[Jaga_awal][_between]=[${kemarin},${besok}]&fields=id, Nama_petugas,Ksm.Nama_ksm,Level.Nama_level_igd,Jaga_awal,Jaga_akhir`)
